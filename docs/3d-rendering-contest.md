...
3. 3D Content
    ...
    - Format:
        ...
        - A file compatible with the following platforms:
            - MeshLab ([https://www.meshlab.net/](https://www.meshlab.net/){:target="_blank"})
            - Nerfstudio ([https://docs.nerf.studio/](https://docs.nerf.studio/){:target="_blank"})
            - Threestudio ([https://github.com/threestudio-project/threestudio](https://github.com/threestudio-project/threestudio){:target="_blank"})
...
| Instructor<br>Schedule | Session 1 | Session 2 |
| :----: | :----: | :----: |
