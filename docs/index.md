...
[Zoom Link](https://kaist.zoom.us/j/83178985125){:target="_blank" .md-button}
...
| 2  | Mar 3  | No Class (Substitute Holiday for<br>the Independence Movement Day) | Mar 5 | **Point Cloud Encoders 1**<br>[**Slides**]({{links.lec03}}){:target="_blank"}<br>[**Recording**]({{links.rec03}}){:target="_blank"} | 
| 3  | Mar 10 | **Point Cloud Encoders 2** | Mar 12 | ==Assignment 1 Session:<br>PointNet== | 
